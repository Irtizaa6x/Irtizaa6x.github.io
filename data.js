...
//   Central data store for Education, Projects, Certifications,
//   Contact, and Social Links.
//
//   NOTE: Experiences and Skills have been moved to:
//          - expdata.js
//          - skdata.js
//   Edit those files separately to update Experience & Skills.
// ============================================================
    ...
    const projects = [
        {
            ...
            description: 'A fully responsive, accessible, and performant portfolio website built with HTML, CSS, and JavaScript. Features a modular architecture, dark mode, and real-time local time display.',
        ...
        },
        {
            ...
            description: 'A Python-based network scanning tool that discovers active hosts, open ports, and services on a local network. Built for learning network security fundamentals.',
